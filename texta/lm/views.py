...
def index(request):
    ...
    template = loader.get_template('lm/lm_index.html')
...
def selectLexicon(request):
    try:
        template = loader.get_template('lm/lexicon.html')
        lexicon = Lexicon.objects.get(id=request.GET['id'])
