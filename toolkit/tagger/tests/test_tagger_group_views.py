...
class TaggerGroupViewTests(APITestCase):
    ...
    def run_tag_text(self):
        ...
        payload = {"text": "see on mingi suvaline naisteka kommentaar. ehk joppab ja saab täägi", "n_documents": 20, "n_candidates": 20}
    ...
    def run_tag_doc(self):
        ...
        payload = {"doc": json.dumps({TEST_FIELD: "This is some test text for the Tagger Test", "n_documents": 20, "n_candidates": 20})}
