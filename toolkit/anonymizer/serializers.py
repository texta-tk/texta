...
class AnonymizerSerializer(serializers.ModelSerializer, ProjectResourceUrlSerializer):
    ...
    auto_adjust_threshold = serializers.BooleanField(default=False, required=False, help_text='Automatically adjust misspelling threshold for avoiding errors with anonymizing very similar names. NB! Automatically adjusted threshold is always >= misspelling_threshold before adjustment. Default=False')
