...
class ElasticMoreLikeThisSerializer(serializers.Serializer):
    ...
    min_term_freq = serializers.IntegerField(default=1, help_text="The minimum term frequency below which the terms will be ignored from the input document.")
    max_query_terms = serializers.IntegerField(default=12, help_text="The maximum number of query terms that will be selected. Increasing this value gives greater accuracy at the expense of query execution speed.")
    min_doc_freq = serializers.IntegerField(default=5, help_text="The minimum document frequency below which the terms will be ignored from the input document.")
    min_word_length = serializers.IntegerField(default=0, help_text="The minimum word length below which the terms will be ignored.")
    max_word_length = serializers.IntegerField(default=0, help_text="The maximum word length above which the terms will be ignored.")
    ...
    size = serializers.IntegerField(min_value=1, max_value=10000, default=10, help_text="How many documents to return with the end result.")
