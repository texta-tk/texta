...
class ProjectViewTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.activate_project_url = f'/projects/{self.test_project.pk}/activate_project/'
    ...
    def test_owner_activate_project(self):
        ...
        self.assertTrue(self.owner.profile in self.test_project.activated_by.all())
    ...
    def test_included_activate_project(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        # Check if the project includes the activated user
        self.assertTrue(self.included_user.profile in self.test_project.activated_by.all())
    ...
    def test_random_activate_project(self):
        ...
        # Check if the project includes the activated user
        self.assertTrue(self.random_user.profile not in self.test_project.activated_by.all())
